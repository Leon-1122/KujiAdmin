  ...
  grunt.config.set('sails-linker', {
    ...
    devJs: {
      ...
      files: {
        ...
        'views/**/*.hbs': require('../pipeline').jsFilesToInject
      }
    },
    ...
    prodJs: {
      ...
      files: {
        ...
        'views/**/*.hbs': ['.tmp/public/min/production.min.js']
      }
    },
    ...
    devStyles: {
      ...
      files: {
        ...
        'views/**/*.hbs': require('../pipeline').cssFilesToInject
      }
    },
    ...
    prodStyles: {
      ...
      files: {
        ...
        'views/**/*.hbs': ['.tmp/public/min/production.min.css']
      }
    },

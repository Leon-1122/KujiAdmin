...
module.exports = {
    paginate: function(model, criteria, currentPage, perPage, populateData, sort, meta, cb) {
        return new Promise(function(resolve, reject) {
            ...
            var meta_data = meta || {};
            model.count(conditions).meta(meta_data).then(function(count) {
                var findQuery = model.find(conditions).meta(meta_data);
                if (sort) {
                ...
                findQuery = findQuery.paginate(pagination.page - 1, pagination.limit);
